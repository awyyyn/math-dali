			...
			<Layout>
				<ImageBackground
					...
					<Text
						...
						You only have {seconds} seconds to answer each problem.
					</Text>

					<Button
						buttonStyle={{ height: 100, borderRadius: 999, width: 100 }}
						onPress={() => {
							setStart(true);
							setIsRunning(true);
						}}
			...
			<Layout>
				<ImageBackground
					...
					<Stack direction="row" justify="between" ph={20} mb={5}>
						...
						<Stack direction="row">
							<Text style={{ color: score >= 4 ? "#25A18E90" : "#9E2A2B" }}>
								{score}{" "}
							</Text>
											...
											<ListItem
												...
												<ListItem.Content
													...
													{item.answer === option ? (
														...
														isEqual &&
														yourAnswer !== item.answer && <Icon name="close" />
													)}
												</ListItem.Content>
											</ListItem>
										);
